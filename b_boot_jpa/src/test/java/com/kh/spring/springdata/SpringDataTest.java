...
public class SpringDataTest {
	...
	@Test
	@DisplayName("카테고리가 문학이고, 도서 재고가 3권 이상이면서 도서명이 '디'로 시작하는 도서를 조회")
	public void test1() {
	...
	public void countByBookAmtGreaterThanEqual() {
		log.info("도서 재고가 2권 이상인 도서의 수량 조회 : " + springDataRepository.countByBookAmtGreaterThanEqual(2));
	}
	
	@Test
	@DisplayName("도서 재고가 10권 이상인 도서가 존재하는지 확인")
	public void existBy() {
		log.info("도서 재고가 10권 이상인 도서 유무 : " + springDataRepository.existsByBookAmtGreaterThanEqual(10));
	}
